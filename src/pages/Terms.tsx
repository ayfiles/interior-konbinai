      ...
      <main className="px-6 lg:px-12 pt-28 pb-16">
        <div className="max-w-[900px] mx-auto">
          <div className="rounded-[24px] bg-black/8 dark:bg-white/10 border border-black/15 dark:border-white/20 backdrop-blur-frosted shadow-[0_8px_30px_rgba(0,0,0,0.25)] p-6 md:p-10">
            <h1 className="text-black dark:text-white font-bold text-[40px] lg:text-[56px] leading-[1.15] tracking-tight mb-4" style={{ fontFamily: "Helvetica, Arial, sans-serif" }}>Allgemeine Geschäftsbedingungen</h1>
            <p className="text-black/80 dark:text-white/80 font-body text-[16px] lg:text-[18px] mb-8">Stand: {new Date().getFullYear()}</p>

            <div className="space-y-6 text-black/85 dark:text-white/85 font-body text-[15px] lg:text-[16px] leading-relaxed">
              <section>
                <h2 className="text-black dark:text-white font-semibold text-[20px] mb-2">1. Geltungsbereich</h2>
              ...
              <section>
                <h2 className="text-black dark:text-white font-semibold text-[20px] mb-2">2. Angebote & Leistungen</h2>
              ...
              <section>
                <h2 className="text-black dark:text-white font-semibold text-[20px] mb-2">3. Vergütung & Zahlungsbedingungen</h2>
              ...
              <section>
                <h2 className="text-black dark:text-white font-semibold text-[20px] mb-2">4. Rechte & Nutzung</h2>
              ...
              <section>
                <h2 className="text-black dark:text-white font-semibold text-[20px] mb-2">5. Mitwirkungspflichten</h2>
              ...
              <section>
                <h2 className="text-black dark:text-white font-semibold text-[20px] mb-2">6. Haftung</h2>
              ...
              <section>
                <h2 className="text-black dark:text-white font-semibold text-[20px] mb-2">7. Schlussbestimmungen</h2>
